        ...
        <section className={styles.section__informacion_personal}>
          <div className={styles.informacion_personal__eliana_moreno}>
            ...
            <p>
              ...
              raíces ancestrales....de un desierto transformado en vergel,
              regado por agua pura de la Cordillera de Los Andes....
            </p>
            <p>
              En mis años de formación profesional participé de gran cantidad de
              congresos, jornadas, eventos y distintas capacitaciones, y logré
              así acceder a trabajar en turismo pasando por un gran abanico de
              ...
              quehacer desde la administración, promociones, ventas,
