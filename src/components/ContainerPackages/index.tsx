...
function ContainerPackages ({ array }): JSX.Element {
  ...
  return (
    <>
      {width <= 320
        ? array.map(c => (
            ...
            >
              ...
              <div className='flex flex-col xsm:flex-row justify-between items-center'>
                ...
                <ButtonItinerario path={c.itinerary} />
              </div>
            </figure>
          ))
        : width <= 375
        ? array.map(c => (
            ...
            >
              <Image
                ...
                alt={c.alt}
              />
              <div className='flex flex-col xsm:flex-row  justify-between items-center w-full'>
                <ButtonMercadoPago link={c['payment-link']} />
                <ButtonItinerario path={c.itinerary} />
              </div>
            </figure>
        ...
        ? array.map(c => (
            <figure
              className='flex flex-col justify-center items-center p-4 max-w-[355px]'
              key={c.id}
            >
              <Image
                priority
        ...
        ? array.map(c => (
            <figure
              className='flex flex-col justify-center items-center p-4 max-w-fit'
              key={c.id}
            >
              <Image
                priority
